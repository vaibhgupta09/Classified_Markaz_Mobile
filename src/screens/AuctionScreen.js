...
export default class AuctionScreen extends PureComponent {
...
this.getRandomPost();
    ...
    .then((responseJson) => {
      ...
      {
          this.setState({randomPost:responseJson.AuctionListView})
      }
        ...
        >
            ...
            <View style={styles.container}>
                    ...
                    <FlatList
                        ...
                        renderItem={({item}) => 
                         <TouchableOpacity onPress={()=>this.getRandomPost()} style={{width:100,height:100,marginLeft:10}}>
                        ...
                        <Text style={{fontSize:23,color:'grey',fontWeight:'bold',textAlign:'center'}}>AUCTIONS CLOSING SOON</Text>
                          <Text style={{fontSize:22,marginTop:5,color:'grey',textAlign:'center'}}>13,007</Text>
                        ...
                        contentContainerStyle={{marginBottom:120}}
                                ...
                                renderItem={({item}) => 
                                <TouchableOpacity onPress={()=>Actions.push('AuctionDetail')} style={{width:width,height:height/3.4,justifyContent:'center',alignItems:'center',marginTop:15}}>
                                ...
                                <Text style={{fontSize:20,color:'grey',fontWeight:'bold',marginTop:5,marginLeft:10}}>{item.productName}</Text>
                                </View>
                                ...
                                <View style={{width:'35%',backgroundColor:'#89898989',borderRadius:8,justifyContent:'center',alignItems:'center',height:'95%',marginTop:'2%'}}>
                                  ...
                                  <Image source={{uri:'https://i.imgur.com/LhFhBio.jpg'}} style={{width:'100%',height:'80%'}}/>
                                  </View>
                                  <View style={{width:'40%',height:"100%"}}>
                                                   <Text style={{fontSize:14,color:'grey',marginTop:10,marginLeft:10}}>AED</Text>
                                                   <Text style={{marginLeft:10,fontSize:20,color:'grey',fontWeight:'bold',marginTop:10}}>{item.currentPrice}</Text>
                                                   <Text style={{marginLeft:10,fontSize:14,color:'grey',marginTop:1}}>Current price</Text>
                                                   <Text style={{marginLeft:10,fontSize:20,color:'grey',fontWeight:'bold',marginTop:10}}>{item.bidPlaced}</Text>
                                                   <Text style={{marginLeft:10,fontSize:14,color:'grey',marginTop:1}}>Bids Placed</Text>
      
                                                   </View>
      
                                         <View style={{width:'25%',height:"100%"}}>
                                                   <Image source={Capture} style={{width:'90%',height:'90%',resizeMode:'contain'}}/>     
                                                       </View>
